...
impl Runtime {
    ...
    pub async fn from_config(config: &Config, marker: Marker) -> Result<Self> {
        ...
        println!("task_bus_routing_key {:?}", config.task_bus_routing_key);
    ...
    >(
        ...
        println!("result_channel_identifier {:?}", result_channel_identifier);
